<script setup>
import { ref } from 'vue'
import { timezones } from '~/data/pages/profilesettingdata'
...
const tagValue = ref([
  { name: 'Us English', code: 'Us English' },
])
...
const success1 = ref(true)
const success2 = ref(true)
const success3 = ref(false)
const success4 = ref(true)

// Methods
function handleSuccess1() {
  success1.value = !success1.value
}
function handleSuccess2() {
  success2.value = !success2.value
}
function handleSuccess3() {
  success3.value = !success3.value
}
function handleSuccess4() {
  success4.value = !success4.value
}
</script>
                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-xl-6">
                            ...
                            <VueMultiselect :show-labels="false" v-model="tagValue"
                                ...
                                track-by="code" :options="tagOptions" :taggable="true" @tag="addTag"></VueMultiselect>
                        </div>
                        <div class="col-xl-6">
                            <label for="profile-timezone" class="form-label">Timezone :</label>
                            <VueMultiselect :show-labels="false" v-model="selectedTimezone"
                                tag-placeholder="Add this as new tag" placeholder="Search or add a tag" label="name"
                                track-by="code" :options="timezones" :taggable="true" @tag="addTag"></VueMultiselect>
                ...
                <div class="card-body">
                    <div class="d-sm-flex d-block align-items-top justify-content-between">
                        <div class="w-50">
                            ...
                            <p class="fs-12 mb-0 text-muted">This helps protect accounts from unauthorized access, even
                                if a password is compromised.</p>
                        </div>
                        <a href="javascript:void(0);" class="link-primary text-decoration-underline">Set Up
                            Verification</a>
                    </div>
                    <div class="d-sm-flex d-block align-items-top justify-content-between mt-3">
                        <div class="w-50">
                            ...
                            <p class="fs-12 mb-0 text-muted">This additional step helps ensure that the person
                                attempting to modify account details is the legitimate account owner.</p>
                        </div>
                ...
                <div class="card-body">
                    <div class="row gx-5 gy-3">
                        <div class="col-xl-12">
                            ...
                            <p class="fs-12 mb-0 text-muted">By configuring notifications, users can tailor their
                                experience to receive alerts for the types of events that matter to them.</p>
                        </div>
                        <div class="col-xl-12">
                            <div class="d-flex align-items-top justify-content-between mt-sm-0 mt-3">
                                <div class="mail-notification-settings">
                                    ...
                                    <p class="fs-12 mb-0 text-muted">Alerts that appear within the application
                                        interface.</p>
                                </div>
                            ...
                            <div class="d-flex align-items-top justify-content-between mt-3">
                                <div class="mail-notification-settings">
                                    ...
                                    <p class="fs-12 mb-0 text-muted">Alerts sent to the user's mobile device or desktop.
                                    </p>
                                </div>
