                ...
                <div class="card custom-card border-0 shadow-none my-4">
                    <div class="card-body p-5">
                        ...
                        <div class="row gy-3">
                            <div class="col-xl-12">
                                ...
                                <div class="position-relative">
                                    <PasswordInput initialValue="" name="newpassword" id="newpassword" placeholder="current password" />
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <label for="reset-newpassword" class="form-label text-default">New Password</label>
                                <div class="position-relative">
                                    <PasswordInput initialValue="" name="newpassword" id="newpassword" placeholder="new password" />
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <label for="reset-confirmpassword" class="form-label text-default">Confirm Password</label>
                                <div class="position-relative">
                                    <PasswordInput initialValue="" name="newpassword" id="newpassword" placeholder="confirm password" />
                                </div>
                            </div>
                        </div>
                        <div class="d-grid mt-3">
                            <NuxtLink to="/" class="btn btn-primary">Reset Password</NuxtLink>
                        </div>
                        ...
                        <div class="text-center mt-3 fw-medium">
                            Dont want to reset? <NuxtLink to="/pages/authentication/sign-in/basic" class="text-primary">login Here</NuxtLink>
                        </div>
                    </div>
                </div>
            </div>
