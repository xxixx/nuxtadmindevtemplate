                                ...
                                <div class="mt-4 mb-3 d-flex align-items-center flex-wrap gap-3 justify-content-between">
                                    <div>
                                        ...
                                        <span class="d-block fw-medium text-muted mb-1">Senior Product
                                            Manager</span>
                                        <p class="fs-12 mb-0 fw-medium text-muted"> <span class="me-3"><i class="ri-building-line me-1 align-middle"></i>New York,
                                                USA</span>
                                            <span class="d-inline-block"><i class="ri-phone-line me-2 align-middle"></i>+1 (123)
                                                456-7890</span>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div>
                                <ul class="nav nav-tabs mb-0 tab-style-8 scaleX" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="profile-about-tab" data-bs-toggle="tab" data-bs-target="#profile-about-tab-pane" type="button" role="tab" aria-controls="profile-about-tab-pane" aria-selected="true">About</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                ...
                                <div class="card custom-card">
                                    <div class="card-header p-0">
                                        <ul class="nav nav-tabs tab-style-8 scaleX justify-content-end" id="myTab4" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="live-stream-tab" data-bs-toggle="tab" data-bs-target="#live-stream-tab-pane" type="button" role="tab" aria-controls="live-stream-tab-pane" aria-selected="false" tabindex="-1"><i class="ri-tv-line lh-1 me-1"></i>Live
                                                    Stream</button>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="card-body">
                                        <div class="tab-content" id="myTabContent3">
                                            ...
                                            <div class="tab-pane overflow-hidden border-0 p-0" id="media-tab-pane" role="tabpanel" aria-labelledby="media-tab" tabindex="0">
                                                <textarea class="form-control mb-3" id="text-area" rows="2" placeholder="What's on your mind?"></textarea>
                                                <file-pond name="test" ref="pond" label-idle="Drag & Drop files here or <span class='filepond--label-action'>Browse</span>" allow-multiple="false" max-files="5" accepted-file-types="image/jpeg, image/png" v-bind:files="myFiles" />
                                                <div class="mt-2">
                                                ...
                                                <div class="d-flex align-items-center lh-1 flex-wrap">
                                                    ...
                                                    <div class="flex-fill">
                                                        <div class="input-group">
                                                            ...
                                                            <button class="btn btn-light border px-2 px-sm-3" type="button"><i class="bi bi-emoji-smile"></i></button>
                                                            <button class="btn btn-light border px-2 px-sm-3" type="button"><i class="bi bi-paperclip"></i></button>
                                                            <button class="btn btn-light border px-2 px-sm-3" type="button"><i class="bi bi-camera"></i></button>
                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        ...
                                        <div class="my-3">Success is not final, failure is not fatal: It is the
                                            courage
                                            to continue that counts. Keep pushing forward! <a href="javascript:void(0);">&#128170; #MotivationMonday</a></div>
                                    </div>
                                    <div class="card-footer">
                                        <div class="d-flex align-items-center gap-2 flex-wrap">
                                            <div class="avatar-list-stacked">
                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        ...
                                        <div class="my-3">The serene beauty of the evening beach with the soft waves
                                            ...
                                            after a long day. &#x1F305; &#127754; <a href="javascript:void(0);">#BeachVibes</a> <a href="javascript:void(0);">#EveningSunset</a> <a href="javascript:void(0);">#Relaxing</a></div>
                                        <div>
