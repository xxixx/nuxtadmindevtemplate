        ...
        <div class="col-xl-12">
            <div class="card custom-card invoice-card">
                <div class="card-body">
                    <div class="row gy-3">
                        <div class="col-xl-12">
                            <img src="/images/brand-logos/desktop-logo.png" alt="" class="img-fluid desktop-logo">
                            <img src="/images/brand-logos/desktop-dark.png" alt="" class="img-fluid desktop-dark">
                        </div>
                        <div class="col-xl-12">
                            <div class="row">
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                    ...
                                    <p class="text-muted">For more information check for <a href="javascript:void(0);"
                                            class="text-primary fw-medium"><u>GSTIN</u></a> Details.</p>
                                </div>
                                                ...
                                                <table class="table table-sm text-nowrap mb-0 table-borderless">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <p class="mb-0 fw-medium fs-16 text-success">$4,349.73
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            ...
                                            <p>
                                                <span class="fw-medium text-muted fs-12">Name On Card :</span> Jack
                                                Miller
                                            </p>
                                            <p>
                                                <span class="fw-medium text-muted fs-12">Card Number :</span> 1234 5678
                                                9087 XXXX
                                            </p>
                                            <p>
                                                <span class="fw-medium text-muted fs-12">Due Date :</span> 29,Dec 2025 -
                                                <span class="text-danger fs-12 fw-medium">30 days due</span>
                                            </p>
                                            <p class="mb-0">
                                                <span class="fw-medium text-muted fs-12">Invoice Status : <span
                                                        class="badge bg-warning-transparent">Pending</span></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
