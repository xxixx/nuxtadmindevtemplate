<script setup>
import * as prism from '@/data/prismCode/forms/formelements/inputgroup.ts';
                ...
                <div class="col-xl-12">
                    <ShowcodeCard :code="prism.buttonsAddons" title="Buttons with dropdowns">
                        ...
                        <div class="input-group flex-nowrap">
                            ...
                            <button class="btn btn-primary-transparent dropdown-toggle px-1 px-sm-3 custom-group ms-0"
