...
import * as prism from '@/data/prismCode/forms/formelements/fileupload';
...
<template>
    ...
    <div class="row">
        <div class="col-xl-12">
            <ShowcodeCard :code="prism.bootstrapFileInput" title="Bootstrap File Input">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control form-control-sm ps-2" id="formFileSm" type="file">
                </div>
                <div>
        ...
        <div class="col-xl-12">
            ...
            <div class="row">
                <div class="col-xl-12">
                     <ShowcodeCard :code="prism.multipleUpload" title="Multiple Upload" >  <!-- custom-add-product -->
                ...
                <div class="col-xl-12">
                    <ShowcodeCard :code="prism.singleUpload" title="Single Upload">
                        <file-pond name="test" ref="pond" class="single-fileupload"
                            label-idle="Drop files here or <span class='filepond--label-action'>Browse</span>"
                            allow-multiple="false" max-files="1" accepted-file-types="image/jpeg, image/png"
                            v-bind:files="myFiles" v-bind:data-style-panel-layout="'circle'" />
                    </ShowcodeCard>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xl-12">
            <ShowcodeCard :code="prism.dropzone" title="Dropzone" class="custom-upload">
                <DropZone :maxFiles="4" title="Drop files here to upload" :uploadOnDrop="true" :multipleUpload="true" :parallelUpload="3" />
            </ShowcodeCard>
        </div>
    </div>
    <!-- End:: row-2 -->
