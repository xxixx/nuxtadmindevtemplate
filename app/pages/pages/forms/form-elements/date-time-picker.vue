...
const dataToPass = {
    ...
    currentpage: "Date & Time Pickers",
    activepage: "Date & Time Pickers"
}
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="input-group salesDatePicker">
                            ...
                            <Datepicker class="form-control custom-date-picker" autoApply placeholder="Choose date"
                                v-model="picked" />
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="input-group flex-nowrap input-group-custom">
                            <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                            <Datepicker class="form-control custom-date-picker" autoApply placeholder="Choose date"
                                :lowerLimit="picked" v-model="picked2" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="input-group flex-nowrap input-group-custom">
                            <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                            <Datepicker class="form-control custom-date-picker" autoApply placeholder="Choose date"
                                :upperLimit="picked1" v-model="picked3" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="input-group flex-nowrap input-group-custom">
                            <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                            <Datepicker class="form-control custom-date-picker" autoApply placeholder="Choose date"
                                v-model="picked4" inputFormat="dd-MM-yyyy" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="input-group input-group-custom">
                            <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                            <Datepicker autoApply placeholder="Date Time"
                                class="form-control datepicker-here custom-date-picker" v-model="picked5"
                                time-picker-inline />
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="input-group input-group-custom">
                            <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                            <Datepicker placeholder="Date Time" class="form-control datepicker-here custom-date-picker"
                                autoApply v-model="month" month-picker />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-0">
                                <div class="input-group input-group-custom">
                                    <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                                    <Datepicker v-model="quarter" autoApply class="form-control custom-date-picker"
                                        quarter-picker />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-0">
                                <div class="input-group input-group-custom">
                                    <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                                    <Datepicker v-model="date1" range multi-calendars autoApply
            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <div class="form-group overflow-auto">
                        <Datepicker class="datepicker-here" inline autoApply v-model="inlinedate"> <template
                                #input-icon>
                                <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                            </template></Datepicker>
                    </div>
