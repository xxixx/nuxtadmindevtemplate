        ...
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    ...
                    <p>An alternative solution is to add a wrapper around the <span class="text-danger">.row</span> with
                        the <span class="text-danger">.overflow-hidden</span> class:
                    </p>
            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    ...
                    <p>Need an edge-to-edge design? Drop the parent <span class="text-danger">.container</span> or <span
                        ...
                        add <span class="text-danger">.mx-0</span> to the <span class="text-danger">.row</span> to
                        prevent overflow.
                    </p>
