            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <div class="card-body bd-example-cssgrid text-center ">
                           <div class="overflow-x-auto">
                            <P>Change the vertical gaps only by modifying the <span class="text-danger">row-gap</span>.
                                Note that we use gap on
                            ...
                            <div class="grid mb-3 grid-autocol-responsive " style="row-gap: 0;">
                                <div class="g-col-6">.g-col-6</div>
                                <div class="g-col-6">.g-col-6</div>
                            ...
                            <p>Because of that, you can have different vertical and horizontal gaps, which
                                ...
                                horizontal).
                                This can be applied with an inline style for <span class="text-danger">gap</span>, or
                                with our <span class="text-danger">--bs-gap</span> CSS
                                variable.</p>
