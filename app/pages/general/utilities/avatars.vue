<script setup>
import * as prism from "@/data/prismCode/utilities/avatars.ts"
import * as avatarData from "@/data/utilities/avatars.ts"
...
<template>
    ...
    <div class="row">
        ...
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <ShowcodeCard :code="prism.avatarSizes"
                title="Avatar Sizes<p class='subtitle text-muted fs-12 fw-normal'>Avatars of different sizes</p>">
                <span :class="`avatar avatar-${idx.class} me-2`" v-for="(idx, index) in avatarData.Avatarsize"
                    :key="index">
                    <img :src="idx.src" alt="img">
                </span>
            </ShowcodeCard>
        ...
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <ShowcodeCard :code="prism.avatarWithIcons"
                ...
                <span :class="`avatar avatar-${idx.class} me-2 avatar-rounded`"
                    v-for="(idx, index) in avatarData.Avataricon" :key="index">
                    <img :src="idx.src" alt="img">
                    <a href="javascript:void(0);" :class="`badge bg-${idx.class1} rounded-pill avatar-badge`"><i
                            :class="`fe fe-${idx.icon}`"></i></a>
                </span>
            </ShowcodeCard>
        </div>
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <ShowcodeCard :code="prism.avatarWithOnlineStatusIndicators"
                ...
                <span :class="`avatar avatar-${idx.class} me-2 online avatar-rounded`"
                    v-for="(idx, index) in avatarData.Avataronline" :key="index">
                    <img :src="idx.src" alt="img">
                </span>
            </ShowcodeCard>
        </div>
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <ShowcodeCard :code="prism.avatarWithOfflineStatusIndicators"
                ...
                <span :class="`avatar avatar-${idx.class} me-2 offline avatar-rounded`"
                    v-for="(idx, index) in avatarData.Avataroffline" :key="index">
                    <img :src="idx.src" alt="img">
                </span>
            </ShowcodeCard>
        </div>
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <ShowcodeCard :code="prism.avatarsWithNumberBadges"
                ...
                <span :class="`avatar avatar-${idx.class} me-2 avatar-rounded`"
                    v-for="(idx, index) in avatarData.Avatarnumber" :key="index">
                    <img :src="idx.src" alt="img">
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-6 col-md-12 col-sm-12">
            <ShowcodeCard :code="prism.avatarWithInitials"
                ...
                <span :class="`avatar avatar-${idx.data} m-2 bg-${idx.color}`"
                    v-for="(idx, index) in avatarData.Avatarinitial" :key="index">
                    {{ idx.data1 }}
                </span>
            </ShowcodeCard>
        </div>
        <div class="col-xl-12 col-lg-6 col-md-12 col-sm-12">
            <ShowcodeCard :code="prism.stackedAvatars"
        ...
        <div class="col-xl-12 col-lg-6 col-md-12 col-sm-12">
            <ShowcodeCard :code="prism.roundedStackedAvatars"
                title=" Rounded Stacked Avatars<p class='subtitle text-muted fs-12 fw-normal'>Group of avatars stacked together.</p>">
                <div class="avatar-list-stacked">
                    <span class="avatar avatar-rounded" v-for="(idx, index) in avatarData.Avatarstack" :key="index">
                        <img :src="idx.src" alt="img">
                    </span>
                    <a class="avatar bg-primary avatar-rounded text-fixed-white" href="javascript:void(0);"> +8 </a>
                </div>
            </ShowcodeCard>
        </div>
    </div>
