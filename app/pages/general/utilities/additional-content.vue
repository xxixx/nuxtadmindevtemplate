            ...
            <div class="row">
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table style="height: 100px; width:auto !important;">
                                    <tbody>
                                        <tr>
                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <div class="card-body"> <span class="align-baseline">baseline</span> <span class="align-top">top</span> <span class="align-middle">middle</span> <span class="align-bottom">bottom</span> <span class="align-text-top">text-top</span> <span class="align-text-bottom">text-bottom</span> </div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body overflow-x-auto">
                    ...
                    <div style="height: 100px; background-color: rgba(255,0,0,0.1);" class="d-flex">
                        <div class="h-25 d-inline-block"
                            style="width: 120px; background-color: rgba(0,0,255,.1);padding-inline:10px;">H 25%
                        </div>
                        <div class="h-50 d-inline-block"
                            style="width: 120px; background-color: rgba(0,0,255,.1);padding:10px;">H 50%
                        </div>
                        <div class="h-75 d-inline-block"
                            style="width: 120px; background-color: rgba(0,0,255,.1);padding:10px;">H 75%
                        </div>
                        <div class="h-100 d-inline-block"
                            style="width: 120px; background-color: rgba(0,0,255,.1);padding:10px;">H 100%
                        </div>
                        <div class="h-auto d-sm-inline-block d-none"
                            style="width: 120px; background-color: rgba(0,0,255,.1);padding:10px;">H auto
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <p><a href="javascript:void(0);" class="pe-none" tabindex="-1" aria-disabled="false"><code
                                        class="text-primary fw-medium">This link</code></a>
                                can
                                not be clicked.
                            </p>
                            <p><a href="javascript:void(0);" class="pe-auto"><code
                                        class="text-primary fw-medium">This link</code></a> can be clicked (this is
                                default
                                behavior).
                            </p>
                            <p class="pe-none mb-0"><a href="javascript:void(0);" tabindex="-1"
                                    aria-disabled="false"><code>This link</code></a>
                                can
                                not be clicked because the <code class="text-primary fw-medium">pointer-events</code>
                                property is inherited
                                from its parent. However, <a href="javascript:void(0);" class="pe-auto">this link</a>
                                has a
