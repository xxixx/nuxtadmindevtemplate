...
import * as prism from '@/data/prismCode/ui-elements/tooltips.ts';
import * as tooltipData from '@/data/ui-elements/tooltips.ts';
            ...
            <ShowcodeCard title="Tooltip Directions" :code="prism.TooltipDirections">
                <div class="btn-list">
                    <button type="button" class="btn btn-primary btn-wave" data-bs-toggle="tooltip"
                        :data-bs-placement="idx.text" :title="`Tooltip on ${idx.text}`"
                        v-for="(idx, index) in tooltipData.Tooltipdirtooltip" :key="index">
                        Tooltip on {{ idx.text }}
                    </button>
                </div>
            </ShowcodeCard>
    ...
    <div class="row">
        <div class="col-xl-12">
            <ShowcodeCard title="Colored Tooltips" :code="prism.ColoredTooltips">
                <div class="btn-list">
                    <button type="button" :class="`btn btn-${idx.color} btn-wave`" data-bs-toggle="tooltip"
                        :data-bs-custom-class="`tooltip-${idx.color}`" :data-bs-placement="idx.dir"
                        :title="`${idx.text} Tooltip`" v-for="(idx, index) in tooltipData.Coloredtooltip" :key="index">
                        {{ idx.text }} Tooltip
                    </button>
                </div>
            </ShowcodeCard>
    ...
    <div class="row">
        ...
        <div class="col-xl-6">
            <ShowcodeCard title="With an SVG's" :code="prism.WithAnSVGs">
                <a href="javascript:void(0);" data-bs-toggle="tooltip" :title="idx.text"
                    :data-bs-custom-class="`tooltip-${idx.color}`" :class="`me-3 svg-${idx.color}`"
                    v-for="(idx, index) in tooltipData.SVGtooltip" :key="index">
        ...
        <div class="col-xl-6">
            <ShowcodeCard title="Tooltip For Images" :code="prism.TooltipForImages">
                ...
                <a href="javascript:void(0);" data-bs-toggle="tooltip" title="Tim Cook"
