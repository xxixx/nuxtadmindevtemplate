<script setup>
import * as prism from "@/data/prismCode/ui-elements/button-group.ts";

const dataToPass = {
    title: "Ui Elements",
    currentpage: "Button Group",
    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <ShowcodeCard title="Social Group Buttons" :code="prism.SocialGroupButtons">
                <div class="btn-group custom-icon-class" role="group" aria-label="Basic example">
