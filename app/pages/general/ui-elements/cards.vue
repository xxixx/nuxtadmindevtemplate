<script setup>
import * as cardData from "@/data/ui-elements/cards.ts"
import media_22 from "/images/media/media-22.jpg"
import media_23 from "/images/media/media-23.jpg"
import media_24 from "/images/media/media-24.jpg"
import media_25 from "/images/media/media-25.jpg"
import media_26 from "/images/media/media-26.jpg"
import media_27 from "/images/media/media-27.jpg"
import media_29 from "/images/media/media-29.jpg"
import media_4 from "/images/media/media-4.jpg"
import media_9 from "/images/media/media-9.jpg"
import media_15 from "/images/media/media-15.jpg"
import media_30 from "/images/media/media-30.jpg"
import media_28 from "/images/media/media-28.jpg"
import media_31 from "/images/media/media-31.jpg"
import media_32 from "/images/media/media-32.jpg"
import media_33 from "/images/media/media-33.jpg"
import media_35 from "/images/media/media-35.jpg"
import media_34 from "/images/media/media-34.jpg"
import media_36 from "/images/media/media-36.jpg"
import media_37 from "/images/media/media-37.jpg"
import media_38 from "/images/media/media-38.jpg"
import media_39 from "/images/media/media-39.jpg"
import media_40 from "/images/media/media-40.jpg"
import media_41 from "/images/media/media-41.jpg"
import media_42 from "/images/media/media-42.jpg"
import media_43 from "/images/media/media-43.jpg"
import media_44 from "/images/media/media-44.jpg"
import media_45 from "/images/media/media-45.jpg"
import media_46 from "/images/media/media-46.jpg"
import media_47 from "/images/media/media-47.jpg"
...
<template>
    ...
    <div class="row">
        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <Spkcard titleClass="fw-medium" imgClass="card-img-top" :imgSrc="media_24" title="Card title">
        ...
        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <Spkcard titleClass="fw-medium" imgClass="card-img-top"
                footer="<span class='card-text'>Last updated 3 mins ago</span>" :imgSrc="media_22" title="Card title">
                <template v-slot:bodyText>
                    <p class="card-text text-muted">when an unknown printer took a galley of type and scrambled it to
        ...
        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <Spkcard imgClass="card-img-top" :imgSrc="media_23">
                <template v-slot:bodyText>
                    <p class="card-text">Some quick example text to build on the card title and
                        make up the bulk of the card's content.</p>
                </template>
        ...
        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <Spkcard headerText="Featured" :header="true" title="Special title treatment">
                <template v-slot:bodyText>
            ...
            <Spkcard title="Card title" subTitle="Card subtitle" :footer="true">
                <template v-slot:bodyText>
                    <p class="card-text">There are many variations of passages of Lorem Ipsum available, but the
                        majority have suffered alteration many variations of passages of Lorem Ipsum available there are
                        so many ways to solve but the majority.</p>
                </template>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-12">
            ...
            <div class="row row-cols-12">
                <div class="col">
                    <Spkcard>
                        <template v-slot:bodyText>
                            <img :src="media_25" class="card-img mb-3" alt="...">
                ...
                <div class="col">
                    <Spkcard>
                        <template v-slot:bodyText>
                            <img :src="media_26" class="card-img mb-3" alt="...">
                ...
                <div class="col">
                    <Spkcard>
                        <template v-slot:bodyText>
                            <img :src="media_27" class="card-img mb-3" alt="...">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="row">
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4">
                            <Spkcard cardClass="overflow-hidden" :bodyText="false">
                                <template v-slot:outBodyText>
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">An item</li>
                                        <li class="list-group-item">A second item</li>
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4">
                            <Spkcard cardClass="overflow-hidden" headerText="Featured" :header="true"
                                :useDivHeader="true" :bodyText="false">
                                <template v-slot:outBodyText>
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">An item</li>
                                        <li class="list-group-item">A second item</li>
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4">
                            <Spkcard cardClass="overflow-hidden" footer="Card footer" cardFooter="border-top-0"
                                :bodyText="false">
                                <template v-slot:outBodyText>
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">An item</li>
    ...
    <div class="row">
        ...
        <div class="col-xl-3">
            <Spkcard cardClass="border border-primary"
        ...
        <div class="col-xl-3">
            ...
            <Spkcard :useDivHeader="true" :header="true" :footer="true">
                <template v-slot:header>
                ...
                <template v-slot:bodyText>
                    If you are going to use, you need to be sure there isn't anything embarrassing hidden in the middle
        ...
        <div class="col-xl-3">
            <Spkcard :useDivHeader="true" :header="true" :footer="true" bodyClass="pt-3"
        ...
        <div class="col-xl-3">
            <Spkcard headerText="Featured" :header="true" titleClass="fw-medium mb-2" cardClass="text-center"
                cardFooter="text-muted" footer="11.32pm">
                <template v-slot:bodyText>
        ...
        <div class="col-xl-3">
            ...
            <Spkcard :useDivHeader="true" :header="true">
                <template v-slot:header>
        ...
        <div class="col-xl-2">
            <Spkcard>
                <template v-slot:bodyText>
                    <img :src="media_4" class="card-img mb-3" alt="...">
                    <h6 class="card-title fw-medium mb-3">Mountains<span
        ...
        <div class="col-xl-2">
            <Spkcard>
                <template v-slot:bodyText>
                    <img :src="media_9" class="card-img mb-3" alt="...">
                    <h6 class="card-title fw-medium mb-3">Hills<span
        ...
        <div class="col-xl-2">
            <Spkcard>
                <template v-slot:bodyText>
                    <img :src="media_15" class="card-img mb-3" alt="...">
                    <h6 class="card-title fw-medium mb-3">Nature<span
        ...
        <div class="col-xl-4">
            ...
            <Spkcollapsecard :collapseToggle="true" Text="Card With Collapse Button"
    ...
    <div class="row">
        <div class="col-xl-3">
            <div class="row">
                ...
                <div class="col-xl-12">
                    <Spkcard :useDivHeader="true" cardClass="border border-success mb-3" :header="true"
                        headerText="Header" cardHeader="bg-transparent border-bottom border-success"
                        bodyClass="text-success" cardFooter="bg-transparent border-top border-success" footer="Footer">
                        <template v-slot:bodyText>
                    ...
                    <Spkcard>
                        <template v-slot:bodyText>
                            ...
                            <p class="card-text">Contrary to popular belief, Lorem Ipsum is not simply random text. It
                                has roots in a piece of classical Latin literature.</p>
                            <a href="javascript:void(0);" class="btn btn-primary">Go somewhere</a>
                        </template>
                    </Spkcard>
                </div>
                <div class="col-xl-4">
                    <Spkcard cardClass="text-end">
                        <template v-slot:bodyText>
                            <div class="mb-2">
                                <span class="avatar avatar-md">
                                    <img :src="face11" alt="img">
                ...
                <div class="col-xl-4">
                    <Spkcard cardClass="text-center">
                        <template v-slot:bodyText>
                            ...
                            <p class="card-text">Many desktop publishing packages and web page editors now use Lorem
    ...
    <div class="row">
        <div class="col-xxl-6 col-xl-12">
            ...
            <div class="row">
                <div class="col-xl-6">
                    <Spkcard :header="true" headerText="Using Width 75%"
                        footer="<a href='#!' class='btn btn-primary d-grid'>Button</a>" cardClass="w-75">
                        <template v-slot:bodyText>
                            <div class="card-text">
                ...
                <div class="col-xl-6">
                    <Spkcard :header="true" headerText="Using Width 50%"
                        footer="<a href='#!' class='btn btn-primary d-grid'>Button</a>" cardClass="w-50">
                        <template v-slot:bodyText>
                            <div class="card-text">
        ...
        <div class="col-xxl-6 col-xl-12">
            ...
            <div class="row">
                <div class="col-xl-6">
                    <Spknavigationcard LinkNavigate="#!" Navigationclass="tabs" Customheaderclass=" p-4 pt-3 ps-2" />
                </div>
                <div class="col-xl-6">
                    <Spknavigationcard LinkNavigate="#!" Navigationclass="pills" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xl-4">
            <Spkcard :imgSrc="media_29" imgClass="card-img-top">
                <template v-slot:bodyText>
        ...
        <div class="col-xl-4">
            <Spkcard :imgSrcB="media_28" imgClassB="card-img-bottom">
                <template v-slot:bodyText>
                    <h6 class="card-title fw-medium">Image caps are widely used in Blog's</h6>
                    <p class="card-text mb-3 text-muted">But I must explain to you how all this mistaken idea of
                        denouncing pleasure and praising pain was born and I will give you a complete account of the
        ...
        <div class="col-xl-4">
            ...
            <Spkcard :imgSrcB="media_31" imgClassB="card-img rounded-0" :header="true"
        ...
        <div class="col-xl-4">
            <Spkcard :imgSrcA="media_32" imgClassA="card-img-top" :header="true"
                headerText="Image caps are widely used in Blog's"
                footer="<p class='card-text mb-0'><small>Last updated 3 mins ago</small></p>">
                <template v-slot:bodyText>
                    <p class="card-text mb-1 text-muted">This is a wider card with supporting text below
        ...
        <div class="col-xl-4">
            <Spkcard :imgSrcB="media_30" imgClassB="card-img rounded-0"
                footer="<p class='card-text mb-0'><small>Last updated 3 mins ago</small></p>">
                <template v-slot:bodyText>
        ...
        <div class="col-xl-4">
            <Spkcard :imgSrcC="media_33" imgClassC="card-img-bottom" :footer="true" :header="true"
                headerText="Image caps are widely used in Blog's">
                <template v-slot:footer>
                    <p class="card-text mb-0"><small>Last updated 3 mins
                            ago</small></p>
    ...
    <div class="row">
        <div class="col-xl-4">
            <Spkimageoverlaycard CustomClass="overlay-card" :Imgsrc="media_35" Title="Image Overlays Are Awesome!"
                CustomTitleclass="text-fixed-white" :CardHeader="true" :CardFooter="false"
        ...
        <div class="col-xl-4">
            <Spkimageoverlaycard CustomClass="overlay-card" Custombodyclass="text-fixed-white overflow-y-scroll"
                Footertext="Last updated 3 mins ago" :Imgsrc="media_36" Customfooterclass="text-fixed-white"
                Overlayclass="over-content-bottom" :CardHeader="false" :CardFooter="true">
                <template v-slot:cardContent>
                    <div class="card-text text-fixed-white custom">
                        Image Overlays Are Awesome!
                    </div>
                    <div class="card-text card-text1 mb-2 overflow-auto">There are many variations of passages of Lorem Ipsum available, but the
                        majority have suffered alteration in some form, by injected humour, or randomised words which
                        don't look even.</div>
                    <div class="card-text">Last updated 3 mins ago</div>
                </template>
        ...
        <div class="col-xl-4">
            <Spkimageoverlaycard CustomClass="overlay-card" Title=" Image Overlays Are Awesome!"
                CustomTitleclass="text-fixed-white" :Imgsrc="media_34"
                Custombodyclass="text-fixed-white overflow-y-auto" Customfooterclass="text-fixed-white py-2 py-sm-3"
                :CardHeader="true" :CardFooter="true" Footertext="Last updated 3 mins ago">
                <template v-slot:cardContent>
    ...
    <div class="row">
        <div class="col-xl-4">
            <Spkhorizontalcard :CardHeader="true" Navigate="javascript:void(0);" Imgposition="before"
                :Imagesrc="media_37" Imgclass="img-fluid rounded-start h-100 w-100" Title="Horizontal Cards"
                CardFooter="true" Footertext="Last updated 3 mins ago">
                <template v-slot:cardContent>
        ...
        <div class="col-xl-4">
            <Spkhorizontalcard :CardHeader="true" Navigate="javascript:void(0);" Imgposition="after"
                :Imagesrc="media_38" Title="Horizontal Cards">
                <template v-slot:cardContent>
                    <h6 class="card-title fw-medium">Horizontal cards are awesome!</h6>
        ...
        <div class="col-xl-4">
            <Spkhorizontalcard :CardFooter="true" Navigate="javascript:void(0);" Footertext="Last updated 3 mins ago"
                Imgposition="after" :Imagesrc="media_39">
                <template v-slot:cardContent>
    ...
    <div class="row">
        <div class="col-xl-3">
            <pkbgcards Navigate="javascript:void(0);" color="primary" :Imgsrc="face11" Title="Adam Smith"
                Value="Finished by today" Textclass="fixed-white" Class="fixed-white" />
        </div>
        <div class="col-xl-3">
            <pkbgcards Navigate="javascript:void(0);" color="secondary" :Imgsrc="face12" Title="Elisha Corner"
                Value="Completed 24 days back" Textclass="fixed-white" Class="fixed-white" />
        </div>
        <div class="col-xl-3">
            <pkbgcards Navigate="javascript:void(0);" color="warning" :Imgsrc="face1" Title="Sarah Alina"
                Value="Completed today" Textclass="fixed-white" Class="fixed-white" />
        </div>
        <div class="col-xl-3">
            <pkbgcards Navigate="javascript:void(0);" color="info" :Imgsrc="face8" Title="Monica Karen"
                Value="Pending from 4 days" Textclass="fixed-white" Class="fixed-white" />
        </div>
        <div class="col-xl-3">
            <pkbgcards Navigate="javascript:void(0);" color="success" :Imgsrc="face5" Title="Samantha sid"
                Value="In leave for 1 month" Textclass="fixed-white" Class="fixed-white" />
        </div>
        <div class="col-xl-3">
            <pkbgcards Navigate="javascript:void(0);" color="danger" :Imgsrc="face14" Title="Sebastien steyn"
                Value="Completed by Tomorrow" Textclass="fixed-white" Class="fixed-white" />
        </div>
        <div class="col-xl-3">
            <pkbgcards Navigate="javascript:void(0);" color="light" :Imgsrc="face13" Title="Jacob Smith"
                Value="Finished by 24,Nov" Textclass="muted" Class="text-default" />
        </div>
        <div class="col-xl-3">
            <pkbgcards Navigate="javascript:void(0);" color="dark" :Imgsrc="face16" Title="Pope Adam"
                Value="Completed on 24,may" Textclass="text-white" Class="white" />
        </div>
    </div>
    <!-- End::row-9 -->
    ...
    <div class="row">
        <div class="col-xl-3" v-for="(idx, index) in cardData.borderCards" :key="index">
            <Spkborderedcards Navigate="javascript:void(0);" :Title="idx.title" :badges="idx.badges"
                :images="idx.images" :Class="idx.Class" :Color="idx.Color" />
        </div>
    </div>
    <!-- End::row-10 -->
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card-group">
                <Spkcard :imgSrcA="media_40" imgClassA="card-img-top"
                ...
                <Spkcard :imgSrcA="media_42" imgClassA="card-img-top"
                    footer="<small class='text-muted'>Last updated 3 mins ago</small>">
                    <template v-slot:bodyText>
                ...
                <Spkcard :imgSrcA="media_41" imgClassA="card-img-top"
                    footer="<small class='text-muted'>Last updated 3 mins ago</small>">
                    <template v-slot:bodyText>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="row row-cols-1 row-cols-md-4 g-4">
                <div class="col">
                    <Spkcard :imgSrcA="media_44" imgClassA="card-img-top">
                        <template v-slot:bodyText>
                ...
                <div class="col">
                    <Spkcard :imgSrcA="media_43" imgClassA="card-img-top">
                        <template v-slot:bodyText>
                ...
                <div class="col">
                    <Spkcard :imgSrcA="media_45" imgClassA="card-img-top">
                        <template v-slot:bodyText>
                ...
                <div class="col">
                    <Spkcard :imgSrcA="media_46" imgClassA="card-img-top">
                        <template v-slot:bodyText>
    ...
    <div class="row">
        <div class="col-xxl-3 col-xl-12">
            <Spkcard :imgSrcA="media_23" imgClassA="card-img-top" linkTag={true} titleClass="fw-medium mb-0"
                title="Forests are Awesome." />
        </div>
        <div class="col-xxl-6 col-xl-6">
            <div class="row">
                <div class="col-xxl-12 col-xl-12">
                    <Spkcard cardClass="card-bg-primary" :linkTag="true">
                        <template v-slot:bodyText>
                            <blockquote class="blockquote mb-0 text-center">
                                <h6 class="text-fixed-white">The best and most beautiful things in the world cannot be
                                    seen or even touched — they must be felt with the heart..</h6>
                ...
                <div class="col-xxl-7 col-xl-12">
                    <Spkhorizontalcard :Linktag="true" Navigate="javascript:void(0);" Imgposition="after"
                        :CardFooter="true" :Imagesrc="media_39" Footertext="Last updated 3 mins ago">
                        <template v-slot:cardContent>
        ...
        <div class="col-xxl-3 col-xl-6">
            <Spkcard :imgSrcA="media_47" imgClassA="card-img-top" :linkTag="true">
                <template v-slot:bodyText>
                    <h6 class="card-title fw-medium">Most tropical areas are suitable</h6>
