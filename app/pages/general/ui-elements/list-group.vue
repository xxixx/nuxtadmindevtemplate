<script setup>
import * as prism from "@/data/prismCode/ui-elements/listgroup.ts"
import * as listData from "@/data/ui-elements/listgroup.ts"
...
<div class="row">
    ...
    <div class="col-xl-6">
        <ShowcodeCard title="Active items" :code="prism.ActiveItems">
            <ul class="list-group">
                <li :class="`list-group-item ${idx.class1} ${idx.liclass}`" v-for="(idx, index) in listData.ActiveButtons" :key="index">
                    <div class="d-flex align-items-center">
                        <div>
                            <span class="fs-15">
                                <i :class="idx.class"></i>
    ...
    <div class="col-xl-6">
        <ShowcodeCard title="buttons" :code="prism.buttons">
            <div class="list-group">
                <button type="button" class="list-group-item list-group-item-action border-bottom-0 active " aria-current="true">Simply dummy text of the printing<span class="badge float-end bg-primary">243</span></button>
                <button type="button" class="list-group-item list-group-item-action border-bottom-0 ">There are many variations of passages<span class="badge float-end bg-secondary-transparent">35</span></button>
                <button type="button" class="list-group-item list-group-item-action border-bottom-0 ">All the Lorem  Ipsum generators<span class="badge float-end bg-info-transparent">132</span></button>
                <button type="button" class="list-group-item list-group-item-action border-bottom-0 ">All the Lorem  Ipsum generators<span class="badge float-end bg-success-transparent">2525</span></button>
...
<div class="row">
    <div class="col-xl-6">
        <ShowcodeCard title="Contextual classes" :code="prism.ContextualClasses">
            <ul class="list-group">
                <li :class="`list-group-item list-group-item-${idx.class} `" v-for="(idx, index) in listData.ContextualButtons" :key="index">{{ idx.text }}</li>
            </ul>
        </ShowcodeCard>
    </div>
    <div class="col-xl-6">
        ...
        <ShowcodeCard title="Custom content" :code="prism.CustomContent">
            <div class="list-group">
                <a href="javascript:void(0);" :class="`list-group-item list-group-item-action ${idx.class1}`" aria-current="true" v-for="(idx, index) in listData.CustomButtons" :key="index">
                    ...
                    <small :class="`${idx.id === 1 ? '' : 'text-muted'}`">{{ idx.text3 }}.</small>
                </a>
            </div>
        </ShowcodeCard>
    </div>
