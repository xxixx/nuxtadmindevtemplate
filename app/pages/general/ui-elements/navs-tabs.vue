                    ...
                    <ul class="nav nav-tabs tab-style-2 nav-justified mb-3 d-sm-flex d-block" id="myTab1"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="order-tab" data-bs-toggle="tab"
                                data-bs-target="#order-tab-pane" type="button" role="tab" aria-controls="home-tab-pane"
                                aria-selected="true"><i class="ri-gift-line me-1 align-middle"></i>Ordered</button>
                        </li>
                        <li class="nav-item" role="presentation">
                ...
                <div class="card-body p-0 pt-3">
                    ...
                    <div class="tab-content p-3" id="myTabContent1">
                        ...
                        <div class="tab-pane fade text-muted" id="profile-tab-pane" role="tabpanel"
                            aria-labelledby="profile-tab" tabindex="0">Many desktop
                            publishing packages as their default model text, and a search for <b>'lorem ipsum'</b> will
                            over the
                            years.</div>
            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs mb-3 tab-style-6" id="myTab3" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="sales-tab" data-bs-toggle="tab"
                                data-bs-target="#sales-tab-pane" type="button" role="tab" aria-controls="sales-tab-pane"
                    ...
                    <div class="tab-content" id="myTabContent2">
                        <div class="tab-pane fade show active p-0 border-bottom-0 overflow-hidden"
                            id="products-tab-pane" role="tabpanel" aria-labelledby="products-tab" tabindex="0">
                            <div class="table-responsive">
                                <TableComponent
                                    :headers="[{ text: 'Product' }, { text: 'Name' }, { text: 'Category' }, { text: 'Price' }]"
                                    :rows="tanStyle" tableClass="table mb-0" v-slot:cell="{ row }">
                                    <td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="tab-content" id="v-pills-tabContent">
                                ...
                                <div class="tab-pane" id="main-email" role="tabpanel" aria-labelledby="main-email-tab"
                                    tabindex="0">
                                    <ul class="list-unstyled text-muted mb-0">
                                        <li class="mb-2">Contrary to popular belief, Lorem Ipsum is not simply
                                            random text. It has roots in a piece of classical Latin literature
