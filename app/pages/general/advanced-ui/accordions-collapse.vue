...
import * as prism from '@/data/prismCode/advancedUi/accordion';
    ...
    <div class="row">
        <div class="col-xl-12">
            <ShowcodeCard :code="prism.example" title="Example">
                <p class="mb-0">
                    <a class="btn btn-primary collapsed mb-2 me-1" data-bs-toggle="collapse" href="#collapseExample"
        ...
        <div class="col-xl-12">
            <ShowcodeCard :code="prism.targetsCollapse" title="Targets Collapse">
                <p class="mb-0">
                    <a class="btn btn-primary mb-2 me-1" data-bs-toggle="collapse" href="#multiCollapseExample1"
                        role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Toggle first
                        element</a>
                    <button class="btn btn-success mb-2 me-1" type="button" data-bs-toggle="collapse"
