...
import { CompaniesTable } from "~/data/dashboards/jobs/searchcompanydata";
const dataToPass = {
...
const DeveloperdataValue = ref('All Categories')
const Developerdata = ref(['All Categories', 'Software Dveloper', 'Web Developer', 'Software Architect', 'IT Hardware', 'Network Engineer', 'Angular Developer', 'React Developer',])
                ...
                <div class="card-body p-0">
                    ...
                    <div class="p-4 border-bottom">
                        ...
                        <div class="px-0 py-3 pb-0">
                            ...
                            <a class="ecommerce-more-link badge bg-primary-transparent" data-bs-toggle="collapse"
                                href="#location-more" role="button" aria-expanded="false"
                                aria-controls="location-more">More</a>
                        </div>
                    </div>
                    <div class="p-4 border-bottom">
            ...
            <div class="row align-items-center mb-4">
                <div class="col-lg-12">
                    <div class="input-group companies-search-input">
                        ...
                        <VueMultiselect :searchable="true" class="form-select rounded-0 p-0 py-1"
                            name="choices-single-default" id="choices-single-default" :show-labels="false"
                            :multiple="false" v-model="DeveloperdataValue" :options="Developerdata" :taggable="false">
                        </VueMultiselect>
                        <input type="text" class="form-control form-control-lg w-25"
                    ...
                    <div class="card custom-card">
                        <div class="card-body">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <h5 class="fw-medium mb-0 flex-grow-1">1287 <span class="fw-normal fs-18">Companies
                                        match for your search</span> </h5>
                                <div class="btn-group">
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table tex-nowrap company-search-table">
                                    <tbody>
                                        <tr v-for="(idx) in CompaniesTable" :key="idx.id">
                                            <td>
                                            ...
                                            <td>
                                                <div class="text-center">
                                                    ...
                                                    <span class="fw-semibold">{{ idx.established }}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="text-center">
                                                    <span class="d-block text-muted fs-13 mb-1">Rating</span>
                                                    <span class="fw-semibold">{{ idx.rating }}<i class="ti ti-star-filled text-warning ms-1 mx-1"></i></span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="text-center">
                                                    <span class="d-block text-muted fs-13 mb-1">Employees</span>
                                                    <span class="fw-semibold">{{ idx.employees }}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="text-center">
                                            ...
                                            <td class="text-end">
                                                <a href="javascript:void(0);"
                                                    class="btn btn-primary-light d-inline-flex align-items-center">Website<i
                                                        class="ti ti-arrow-narrow-right ms-2"></i></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
