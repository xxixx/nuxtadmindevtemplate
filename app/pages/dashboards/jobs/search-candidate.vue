<script setup>
import { Peopletable } from "@/data/dashboards/jobs/searchcandidatedata.ts"
...
const Data = ref(['Software Dveloper', 'Web Developer', 'Software Architect', 'IT Hardware', 'Network Engineer', 'React Developer',])
const Data2Value = ref(null)
const Data2 = ref(['Fresher', '1 Year Exp', '2 Year Exp', '3 Year Exp', '4 Year Exp', '5+ Year Exp',])
...
<template>
    ...
    <!-- Start::row-1 -->
    <div class="row">
        <div class="col-xxl-3 col-xl-3 search-jobs-nav">
                ...
                <div class="card-body p-0">
                    <div class="px-2 py-4 px-sm-4 border-bottom">
                        ...
                        <div class="px-2 py-3 pb-0">
                            ...
                            <a class="badge bg-primary-transparent" data-bs-toggle="collapse" href="#category-more"
                                role="button" aria-expanded="false" aria-controls="category-more">More</a>
                        </div>
                    </div>
                    <div class="px-2 py-4 px-sm-4 border-bottom">
                    ...
                    <div class="px-2 py-4 px-sm-4 border-bottom">
                        ...
                        <div class="px-2 py-3 pb-0">
                            ...
                            <div class="form-check mb-2">
                                ...
                                <span class="badge bg-light text-default fw-500 float-end">234</span>
                            </div>
                            <div class="form-check mb-2">
                                ...
                                <span class="badge bg-light text-default fw-500 float-end">78</span>
                            </div>
                            <div class="form-check mb-2">
                                ...
                                <span class="badge bg-light text-default fw-500 float-end">531</span>
                            </div>
                            <div class="form-check">
                    ...
                    <div class="px-2 py-4 px-sm-4">
                        ...
                        <div class="px-2 py-3 pb-0">
                            ...
                            <a class="badge bg-primary-transparent" data-bs-toggle="collapse" href="#sizes-more"
        ...
        <div class="col-xxl-9 col-xl-9 serach-jobs-main">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="card custom-card border-0 shadow-none">
                        <div class="card-body p-md-0">
                            <div class="input-group companies-search-input flex-nowrap">
                                <input type="text" class="form-control form-control-lg w-25"
                                    aria-label="Text input with segmented dropdown button"
                                    placeholder="Enter your keyword here">
                                <VueMultiselect :searchable="true" class="form-select px-0 py-1 rounded-0"
                                    placeholder="All Categories" :show-labels="false" :multiple="false"
                                    v-model="DataValue" :options="Data" :taggable="false">
                                </VueMultiselect>
                                <input type="text" class="form-control form-control-lg w-25"
                                    aria-label="Text input with segmented dropdown button"
                                    placeholder="Search by location">
                                <VueMultiselect :searchable="true" class="form-select px-0 py-1 rounded-0"
                                    placeholder="Experience Level" :show-labels="false" :multiple="false"
                    ...
                    <div class="card custom-card">
                        <div class="card-body">
                            <div class="d-flex flex-wrap gap-2 align-items-center">
                                <h5 class="fw-medium mb-0 flex-grow-1">1287 <span class="fw-normal fs-18">Candidates
                                        match your search</span> </h5>
                                <div class="btn-group">
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <TableComponent tableClass="table text-nowrap"
                                    :headers="[{ text: 'Details', thClass: '' }, { text: 'Education', thClass: '' }, { text: 'Skills', thClass: '' }, { text: 'Job Type', thClass: '' }, { text: 'Salary Expectation', thClass: '' }, { text: 'Notice Period', thClass: '' }, { text: 'Actions', thClass: 'text-center' },]"
                                    :rows="Peopletable" v-slot:cell="{ row }">
                                    <td>
                                        <div>
                                            <div class="d-flex align-items-start gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="text-muted fs-13 d-block mb-1">{{ row.location
                                                        }}</span>
                                                    <span href="javascript:void(0);"
                                                        class="badge badge-md rounded-pill bg-primary-transparent"><i
                                                            class="bi bi-briefcase me-1 align-middle"></i>Exp : {{
                                                                row.experience }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-1 skills-container flex-wrap">
                                            <span :class="`badge bg-${skill.color}-transparent`"
                                                v-for="(skill, index) in row.skills" :key="index">
                                                {{ skill.name }}
                                            </span>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <span class="fw-medium">{{ row.salaryRange }}</span>
                                    </td>
                                    <td>
                                        {{ row.noticePeriod }}
                                    </td>
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item d-inline-flex align-items-center"
                                                        href="javascript:void(0);"><i
                                                            class="ti ti-file-text me-2"></i>Download CV</a></li>
                                                <li><a class="dropdown-item d-inline-flex align-items-center"
                                                        href="javascript:void(0);"><i
                                                            class="ti ti-eye me-2"></i>View</a></li>
                                                <li><a class="dropdown-item d-inline-flex align-items-center"
                                                        href="javascript:void(0);"><i
                                                            class="ti ti-checklist me-2"></i>Shortlist</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </TableComponent>
