<script setup>
import * as salesData from "@/data/dashboards/salesdata.ts";
// definePageMeta({
//     middleware: ["auth"],
// })
...
<template>
    ...
    <div class="d-flex align-items-center justify-content-between mb-3 page-header-breadcrumb flex-wrap gap-2">
        ...
        <div class="d-flex align-items-center flex-wrap">
            <div class="form-group custom-sales-datepicker ">
                <Datepicker placeholder="Search By Date Range" class="form-control breadcrumb-input border-0 bg-white custom-date-input " autoApply v-model="date" range />
            </div>
            <div class="btn-list custom-button-list">
                <button class="btn btn-icon btn-primary btn-wave me-2">
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body pb-0 pt-5">
                            <div id="sales-overview">
                                <apexchart height="335px" type="bar" :options="salesData.overviewoptions"
                    ...
                    <div class="card custom-card shadow-none card-bg-primary overflow-hidden dashboard-banner-card">
                        <div class="card-body">
                            <div class="dashboard-banner-card-background">
                                <img src="/images/media/backgrounds/8.png " alt="">
                            </div>
                            <div class="d-flex align-items-center justify-content-between gap-3">
                                <div>
                                    <h5 class="fw-semibold mb-1 text-fixed-white">Hi, Tom Phillip &#128075;</h5>
                                    <span class="d-block fs-14 mb-3 pe-5 text-fixed-white">Check out the latest
                                        sales updates.</span>
                                    <a href="javascript:void(0)" class="btn btn-secondary btn-wave mt-1">Upgrade To
                                        Pro <i class="ti ti-arrow-narrow-right"></i></a>
                                </div>
                                <div class="dashboard-banner-image d-sm-block d-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="748.82965"
                                        height="557.20035" viewBox="0 0 748.82965 557.20035"
                                        ...
                                        <path
                                            ...
                                            fill="rgba(255, 255, 255, 0.2)" />
                                        <polygon
                                            points="373.867 536.045 362.393 541.58 335.583 499.958 352.517 491.789 373.867 536.045"
                                            fill="#ffb6b6" />
                                        <path
                                        ...
                                        <path
                                            ...
                                            transform="translate(-225.58517 -171.39982)" fill="#2f2e41" />
                                        <polygon
                                            points="470.462 475.448 489.209 474.029 486.873 523.483 474.17 524.444 470.462 475.448"
                                            fill="#ffb6b6" />
                                        <path
                                        ...
                                        <path
                                            ...
                                            transform="translate(-225.58517 -171.39982)" fill="rgb(255,255,255)" />
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body pb-0 px-0">
                            <div id="visitors-report">
                                <apexchart height="270px" type="radar" :options="salesData.visitorsoptions"
            ...
            <div class="card custom-card overflow-hidden">
                <div class="card-header justify-content-between">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <div class="dropdown custom-sales-dropdown">
                            <a href="javascript:void(0);"
                                class="btn border btn-wave waves-effect waves-light"
                ...
                <div class="card-body p-0">
                    <TableComponent tableClass="table text-nowrap recent-invoices-table table-hover" :showCheckbox="true"
                        ...
                        <td :class="row.tableClass">
                            <div class="dropdown">
                                <a aria-label="anchor" href="javascript:void(0);"
                                    class="btn btn-icon btn-sm border text-default bg-light" data-bs-toggle="dropdown"
                    ...
                    <TableComponent tableClass="table text-nowrap"
                        ...
                        <td :class="row.tdClass">
                            <div class="avatar-list-stacked text-end">
                                <span v-for="(image, index) in row.avatars" :key="index"
                                    class="avatar avatar-rounded avatar-sm bg-light">
                                    <img :src="image.src" :alt="image.alt">
