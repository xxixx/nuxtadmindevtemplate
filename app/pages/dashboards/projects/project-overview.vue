        ...
        <div class="col-xxl-6">
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <div class="btn-list">
                        <NuxtLink to="/dashboards/projects/create-project" class="btn btn-sm btn-primary btn-wave"><i
                                class="ri-add-line align-middle me-1 fw-medium"></i>Create Project</NuxtLink>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4 gap-2 flex-wrap">
                        <div class="lh-1">
                            <span class="avatar avatar-lg me-1 bg-primary"><i
                        ...
                        <div>
                            ...
                            <span class="text-muted fs-12"><i class="ri-circle-fill text-success mx-2 fs-9"></i>Last
                        ...
                        <div class="ms-auto align-self-start">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><a class="dropdown-item" href="javascript:void(0);"><i
                                                class="ri-delete-bin-line me-1 d-inline-block"></i>Delete</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <p class="text-muted mb-4">The Customer Feedback Dashboard Development project aims to create a
                        comprehensive dashboard that aggregates and visualizes customer feedback data. This will enable
                        our team to gain actionable insights and improve customer satisfaction.</p>
                    <div class="d-flex gap-5 mb-4 flex-wrap">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <span class="avatar avatar-md avatar-rounded me-1"><img src="/images/faces/11.jpg"
                                    alt=""></span>
                            <div>
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-xl-12">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary-light btn-wave btn-sm">See
                                        More</a>
                                </div>
                                <ul class="list-group subtask-list">
                                    <li :class="`list-group-item ${idx.liClass}`" v-for="(idx) in ProjectOverview.Tasks"
                                        :key="idx.id">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        <span :class="`badge bg-${idx.className}-transparent`" v-for="(idx) in ProjectOverview.Badges"
                            :key="idx.id">{{ idx.label }}</span>
                    </div>
                </div>
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item" v-for="(idx) in ProjectOverview.Filedocument" :key="idx.id">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                ...
                                <div class="flex-fill">
                                    <a href="javascript:void(0);"><span class="d-block fw-medium">{{ idx.name
                                            }}</span></a>
                                ...
                                <draggable tag="tbody" item-key="id" id="todo-drag">
                                    <tr class="todo-box" v-for="(idx) in ProjectOverview.TodoItems" :key="idx.id">
                                        <td class="task-checkbox"><input class="form-check-input" type="checkbox"
                                                value="" aria-label="..." :checked="idx.checked"></td>
                                        <td>
                                        ...
                                        <td>
                                            <span :class="`badge bg-${idx.badgeClass}-transparent`"><i
