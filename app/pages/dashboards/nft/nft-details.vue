...
import * as NftDetailsData from "~/data/dashboards/nft/nftdetailsdata";
                            ...
                            <div class="row">
                                <div class="col-xxl-12 col-sm-12 mb-md-5 mb-3">
                                    <swiper :autoplay="true" :style="{
                                        ...
                                        <swiper-slide><img class="img-fluid rounded"
                                                src="/images/nft-images/14.png" /></swiper-slide>
                                        <swiper-slide><img class="img-fluid rounded"
                                                src="/images/nft-images/13.png" /></swiper-slide>
                                        <swiper-slide><img class="img-fluid rounded"
                                                src="/images/nft-images/12.png" /></swiper-slide>
                                        <swiper-slide><img class="img-fluid rounded"
                                                src="/images/nft-images/10.png" /></swiper-slide>
                                    </swiper>
                                    <swiper :autoplay="true" @swiper="setThumbsSwiper" :spaceBetween="10"
                                        :slidesPerView="4" :freeMode="true" :watchSlidesProgress="true"
                                        :modules="modules" class="swiper swiper-view-details mt-2">
                                ...
                                <div class="col-xxl-12 col-sm-12 d-md-block d-none">
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        ...
                                        <a href="javascript:void(0);" class="d-block text-muted fs-13">View All<i
                                                class="ti ti-arrow-narrow-right ms-1"></i></a>
                                    </div>
                                    <ul class="list-group">
                                        <li :class="`list-group-item ${idx.liClass}`"
                                            v-for="(idx) in NftDetailsData.NftList" :key="idx.id">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div class="flex-fill">
                                                    ...
                                                    <span class="d-block text-muted fs-13">{{ idx.address }}</span>
                                                </div>
                                                <div class="text-end">
                                                    <span class="d-block fw-semibold">{{ idx.price }} ETH</span>
                                                    <span class="text-muted fs-13">{{ idx.time }}</span>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                                ...
                                <div class="col-xl-12 mt-xxl-0 mt-3">
                                    <div>
                                        ...
                                        <div class="fs-13 mb-4">
                                            <span class="fw-medium text-muted"><i
                                                    class="ri-heart-3-fill text-danger align-middle me-2"></i>(2.4k
                                                Likes)</span>
                                        </div>
                                        <div class="row mb-4">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-7">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table
                                                            class="table table-bordered text-nowrap product-details-table">
                                                            <tbody>
                                                                <tr v-for="(idx) in NftDetailsData.NftData"
                                                                    :key="idx.id">
                                                ...
                                                <div class="col-xl-5">
                                                    ...
                                                    <ul class="mb-0 ps-3">
                                                        <li class="text-muted mb-2"
                                                            v-for="(idx) in NftDetailsData.NftInfo" :key="idx.id">
                                                            <span class="text-default">{{ idx.label }} :</span> {{
                                                                idx.value }}
                                                        </li>
                                                    </ul>
                                                </div>
                                        ...
                                        <div class="mb-0">
                                            ...
                                            <div class="row">
                                                <div class="col-xxl-4 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                    ...
                                                    <div :class="`d-flex align-items-center ${idx.class}`"
                                                        v-for="(idx) in NftDetailsData.NftRatings" :key="idx.id">
                                                        <div class="fs-12 me-2 fw-medium">{{ idx.stars }} <i
                                                                class="ri-star-fill fs-10"></i></div>
                                                        <div class="progress progress-xs flex-fill">
                                                            <div :class="`progress-bar bg-${idx.color}`"
                                                                role="progressbar" :style="`width: ${idx.percentage}%`"
                                                ...
                                                <div
                                                    ...
                                                    <div class="border rounded p-3">
                                                            ...
                                                            <div class="d-flex flex-fill">
                                                                <div class="me-2">
                                                                    <span class="avatar avatar-lg avatar-rounded">
                                                                        <img src="/images/nft-images/14.png" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="lh-1 me-2">
                                                                    ...
                                                                    <div class="mb-1">
                                                                        <i
                                                                            class="ri-star-fill text-warning align-middle fs-12 me-1"></i>
                                                                        <i
                                                                            class="ri-star-fill text-warning align-middle fs-12 me-1"></i>
                                                                        <i
                                                                            class="ri-star-fill text-warning align-middle fs-12 me-1"></i>
                                                        ...
                                                        <div class="mb-3">
                                                            <p class="fw-medium mb-1">Love the artwork! It's
                                                                amazing!&#128512;</p>
                                                            <p class="mb-0 fs-12 text-muted">Absolutely stunning! This
                                                                NFT is a true masterpiece that blends creativity and
                                                                technology in a way that’s both captivating and unique.
                                                                I’m beyond excited to own such a one-of-a-kind digital
                                                                asset. A perfect addition to any collection!</p>
                                                        </div>
                                                        <div class="product-images ps-0">
                                                            <div class="row">
                                                                <div class="col-xl-6">
                                                                    <div class="products-review-images">
                                                                        <a href="javascript:void(0);">
                                                                            <img src="/images/nft-images/44.png" alt="">
                                                                        </a>
                                                                        <a href="javascript:void(0);">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <button
                                                                        class="btn btn-sm btn-warning-light me-2">Report
                                                                        abuse</button>
                                                                    <button
                                                                        class="btn btn-sm btn-icon btn-success-light me-2">
