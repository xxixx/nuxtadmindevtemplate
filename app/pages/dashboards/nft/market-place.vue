<script setup>
import { MartketPlaceItems, MartketPlaceItems1 } from "~/data/dashboards/nft/marcketplacedata";
                            ...
                            <ul class="nav nav-tabs nav-tabs-header mb-0" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" data-bs-toggle="tab" role="tab" aria-current="page"
                                        href="#nft-all" aria-selected="true">All</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                                        href="#nft-art" aria-selected="false" tabindex="-1">Art</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                                        href="#nft-gaming" aria-selected="false" tabindex="-1">Gaming</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                                        href="#nft-domain" aria-selected="false" tabindex="-1">Domain</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                                        href="#nft-music" aria-selected="false" tabindex="-1">Music</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                                        href="#nft-realestate" aria-selected="false" tabindex="-1">Real Estate</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                                        href="#nft-sports" aria-selected="false" tabindex="-1">Sports</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                                        href="#nft-fashion" aria-selected="false" tabindex="-1">Fashion</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                                        href="#nft-avatars" aria-selected="false" tabindex="-1">Avatars</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                                        href="#nft-memes" aria-selected="false" tabindex="-1">Memes</a>
                                </li>
                            </ul>
                        </div>
                        <div class="d-flex gap-2">
                            ...
                            <div class="dropdown">
                                <a href="javascript:void(0);"
                                    class="btn btn-sm btn-wave btn-primary waves-effect waves-light"
        ...
        <div class="col-xl-12">
            <div class="tab-content">
                <div class="tab-pane show active p-0 border-0" id="nft-all" role="tabpanel">
                    <div class="row">
                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12"
                            v-for="(idx) in MartketPlaceItems" :key="idx.id">
                ...
                <div class="tab-pane p-0 border-0" id="nft-art" role="tabpanel">
                    <div class="row">
                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12"
                            v-for="(idx) in MartketPlaceItems1" :key="idx.id">
                            <SpkNftReusebleCard :card="idx" />
                        </div>
                ...
                <div class="tab-pane p-0 border-0" id="nft-gaming" role="tabpanel">
                    <div class="row">
                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12" v-for="(idx) in Market"
                            :key="idx.id">
                            <SpkNftReusebleCard :card="idx" />
                        </div>
                    </div>
                ...
                <div class="tab-pane p-0 border-0" id="nft-domain" role="tabpanel">
                    <div class="row">
                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12" v-for="(idx) in MarketDomain"
                            :key="idx.id">
                            <SpkNftReusebleCard :card="idx" />
                        </div>
                    </div>
                ...
                <div class="tab-pane p-0 border-0" id="nft-music" role="tabpanel">
                    <div class="row">
                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12" v-for="(idx) in MarketMusic"
                            :key="idx.id">
                            <SpkNftReusebleCard :card="idx" />
                        </div>
                    </div>
                ...
                <div class="tab-pane p-0 border-0" id="nft-realestate" role="tabpanel">
                    <div class="row">
                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12" v-for="(idx) in MarketReal"
                            :key="idx.id">
                            <SpkNftReusebleCard :card="idx" />
                        </div>
                    </div>
                ...
                <div class="tab-pane p-0 border-0" id="nft-sports" role="tabpanel">
                    <div class="row">
                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12" v-for="(idx) in MarketSports"
                            :key="idx.id">
                            <SpkNftReusebleCard :card="idx" />
                        </div>
                    </div>
                ...
                <div class="tab-pane p-0 border-0" id="nft-fashion" role="tabpanel">
                    <div class="row">
                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12" v-for="(idx) in MarketFashion"
                            :key="idx.id">
                            <SpkNftReusebleCard :card="idx" />
                        </div>
                    </div>
                ...
                <div class="tab-pane p-0 border-0" id="nft-avatars" role="tabpanel">
                    <div class="row">
                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12" v-for="(idx) in MarketAvatars"
                            :key="idx.id">
                            <SpkNftReusebleCard :card="idx" />
                        </div>
                    </div>
                ...
                <div class="tab-pane p-0 border-0" id="nft-memes" role="tabpanel">
                    <div class="row">
                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12" v-for="(idx) in MarketMemes"
                            :key="idx.id">
                            <SpkNftReusebleCard :card="idx" />
                        </div>
                    </div>
