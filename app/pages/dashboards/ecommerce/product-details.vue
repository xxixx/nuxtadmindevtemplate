...
import * as productDetails from "../../../data/dashboards/ecommerce/productdetails"
import {
    ref
} from 'vue';
import {
            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="row g-5">
                            <div class="col-xl-6">
                                <swiper class="swiper swiper-preview-details bg-light product-details-page " swiper
                                    :autoplay="true" :style="{
                                        '--swiper-navigation-color': '#fff',
                                        '--swiper-pagination-color': '#fff',
                                    }" :spaceBetween="20" :navigation="true" :thumbs="{ swiper: thumbsSwiper }"
                                    :modules="modules">
                                    <swiper-slide class="swiper-slide" id="img-container">
                                        <img class="img-fluid" src="/images/ecommerce/jpg/4.jpg" alt="img">
                                    </swiper-slide>
                                    <swiper-slide class="swiper-slide image-container">
                                        <img class="img-fluid" src="/images/ecommerce/jpg/2.jpg" alt="img">
                                    </swiper-slide>
                                    <swiper-slide class="swiper-slide image-container">
                                        <img class="img-fluid" src="/images/ecommerce/jpg/3.jpg" alt="img">
                                    </swiper-slide>
                                    <swiper-slide class="swiper-slide image-container">
                                        <img class="img-fluid" src="/images/ecommerce/jpg/1.jpg" alt="img">
                                    </swiper-slide>
                                    <swiper-slide class="swiper-slide image-container">
                                        <img class="img-fluid" src="/images/ecommerce/jpg/5.jpg" alt="img">
                                    </swiper-slide>
                                    <swiper-slide class="swiper-slide image-container">
                                        <img class="img-fluid" src="/images/ecommerce/jpg/6.jpg" alt="img">
                                    </swiper-slide>
                                </swiper>
                                <swiper class="swiper swiper-view-details mt-2" :autoplay="false"
                                    @swiper="setThumbsSwiper" :spaceBetween="10" :slidesPerView="6" :freeMode="true"
                            ...
                            <div class="col-xl-6">
                                <div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="mb-1 d-flex align-items-center"><span
                                                class="h3 fw-semibold mb-0"><sup class="fs-14">$</sup>129.99</span><span
                                                class="ms-3 badge bg-danger-transparent">50% Off</span></div>
                                        <p class="mb-0 text-muted">M.R.P : <s>$259.99</s></p>
                                    </div>
                                    <div class="mb-4">
                                        <h6 class="fw-semibold mb-3">Description :</h6>
                                        <p class="text-muted mb-0">
                                            These stylish Nike Air Max 2025 sneakers are designed for ultimate comfort
                                            and
                                            durability. Featuring a sleek, breathable mesh upper, the shoe’s advanced
                                            Air
                                            Max cushioning system ensures you stay comfortable on your feet all day
                                            long.
                                            Whether you're running errands or running a marathon, these sneakers will
                                            give
                                            you the support you need. Available in multiple colors.
                                        </p>
                                    </div>
                                    <div class="mb-4">
                                ...
                                <div class="d-flex align-items-center justify-content-center gap-2 mt-5 flex-wrap">
                                    <NuxtLink to="/dashboards/ecommerce/cart"
                                        class="btn btn-primary btn-lg btn-w-lg border"><i
                                            class="ti ti-shopping-cart mx-1"></i>Add To Cart</NuxtLink>
                                    <NuxtLink to="/dashboards/ecommerce/checkout"
                                        class="btn btn-primary btn-lg btn-w-lg border">Buy Now</NuxtLink>
                                </div>
                            </div>
                            <div class="col-xxl-12 col-xl-12">
                                <div class="row justify-content-center mb-4">
                                    <div v-for="(item, index) in productDetails.assuranceCards" :key="index"
                                        class="col-xxl-4 col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12 mt-sm-0 mt-3 ">
                                        <div class="ecommerce-assurance p-5 text-center">
                                            <div class="lh-1 mb-3">
                                ...
                                <div class="mb-4">
                                    <div class="row g-5">
                                        <div class="col-xl-6">
                                            ...
                                            <TableComponent
                                                tableClass="table table-bordered text-lg-wrap product-details-table" theadClass="d-none"
                                                :rows="productDetails.productDetailsdata" v-slot:cell="{ row }">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="mb-4">
                                                ...
                                                <ul class="list-unstyled product-details-features-list">
                                                    <li v-for="(item, index) in productDetails.productFeatures"
                                                        :key="index">
                                                        {{ item }}
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <ul class="list-unstyled product-details-features-list">
                                                    <li v-for="(item, index) in productDetails.careInstructions"
                                                        :key="index">
                                                        {{ item }}
                                                    </li>
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="row">
                                        <div class="col-xxl-4 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div v-for="(item, index) in productDetails.ratings" :key="index"
                                                class="d-flex align-items-center mb-3">
                                                <div class="fs-12 me-2 fw-semibold">{{ item.stars }}<i
                                                        class="ri-star-fill fs-10 mx-1"></i>
                                                </div>
                                        ...
                                        <div class="col-xxl-8 col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-xxl-0 mt-3">
                                            <div class="border p-3">
                                                <div class="d-sm-flex d-block align-items-top mb-3">
                                                    <div class="d-flex flex-fill align-items-start gap-3">
                                                        ...
                                                        <div class="lh-1 me-2">
                                                            ...
                                                            <div class="mb-1">
                                                                <i
                                                                    class="ri-star-s-fill text-warning align-middle fs-12"></i>
                                                                <i
                                                                    class="ri-star-s-fill text-warning align-middle fs-12"></i>
                                                                <i
                                                                    class="ri-star-s-fill text-warning align-middle fs-12"></i>
                                                                <i
                                                                    class="ri-star-s-fill text-warning align-middle fs-12"></i>
                                                                <i
                                                                    class="ri-star-s-line text-warning align-middle fs-12"></i>
                                                            </div>
                                                ...
                                                <div class="ps-sm-3 ps-0 mb-3">
                                                    ...
                                                    <p class="mb-0 text-muted ps-2">The comfort is unmatched! I love the
                                                        sleek design, and the Air Max cushioning is fantastic.</p>
                                                </div>
                                                <div class="product-images ps-sm-4 ps-0">
                                                    <div class="row">
                                                        ...
                                                        <div
                                                            class="col-xl-6 d-flex align-items-end justify-content-sm-end mt-sm-0 mt-2 flex-wrap gap-2">
                                                            <button class="btn btn-sm btn-warning-light me-2">Report
                                                                abuse</button>
