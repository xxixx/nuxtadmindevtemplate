<script setup>
import * as orderDetailsData from "../../../data/dashboards/ecommerce/orderdetailsdata";
const dataToPass = {
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table nowrap text-nowrap">
                                    ...
                                    <tbody>
                                        <tr v-for="(item, index) in orderDetailsData.detailsTable" :key="index">
                                            <td>
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="d-flex align-items-center gap-2 fs-13">
                                                            <div>Color : <span class="fw-medium text-muted">{{
                                                                item.color }}</span></div>
                                                            <div class="vr"></div>
                                                            <div class="">Size : <span class="fw-medium text-muted">{{
                                                                item.size }}</span></div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled order-activity-list">
                                <li v-for="(item, index) in orderDetailsData.orderTimeline" :key="index"
                                    :class="`${item.isCompleted ? '' : 'pending'}`">
                                    <div class="d-flex align-items-start justify-content-between">
                                        ...
                                        <div class="fs-13 text-end">
                                            ...
                                            <span class="d-block text-muted">{{ item.isCompleted ? item.time : ''
                                            }}</span>
                                        </div>
                                    </div>
                                </li>
            ...
            <div class="row">
                    ...
                    <div class="card custom-card overflow-hidden">
                        ...
                        <div class="card-body p-0">
                            <ul class="list-group list-group-flush">
                                <li v-for="(item, index) in orderDetailsData.userInfoList" :key="index"
                                    class="list-group-item">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="fs-13 text-muted"><i :class="`${item.icon} me-2 fs-14`"></i>{{
                                            item.label }}</div>
                                        <div class="d-flex align-items-center gap-2" v-html="item.value"></div>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <div class="card-body p-0">
                            <ul class="list-group list-group-flush">
                                <li v-for="(item, index) in orderDetailsData.paymentDetails" :key="index"
                                    class="list-group-item">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div
                                            :class="`${item.label === 'Payment Status' ? 'badge bg-success-transparent fs-13' : 'fw-medium'}`">
                                            {{ item.value }}</div>
                                    </div>
                                </li>
                            </ul>
