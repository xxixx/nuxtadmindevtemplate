    ...
    <div class="card custom-card mb-0">
        <div class="card-body">
                ...
                <div class="d-flex flex-fill align-items-center">
                    <div class="me-2 lh-1">
                        <span class="avatar avatar-md">
                            <img :src="card.imgSrc" alt="" class="invert-1">
                        </span>
                    </div>
                    <div class="lh-1">
                        <span class="d-block text-default fw-medium">{{ card.title }}</span>
                    </div>
                </div>
                <div class="fs-12 text-end">
                    <span class="text-uppercase fw-semibold">{{ card.subtitle }}</span>
                    <span :class="`text-${card.percentColor} d-block`">{{ card.percent }}<i
            ...
            <div class="d-flex align-items-end justify-content-between">
                ...
                <div :id="card.chartId">
                    <apexchart :height="height" :type="card.type" :width="width" :options="card.chartOptions"
                        :series="card.chartSeries"></apexchart>
                </div>
            </div>
        </div>
    </div>
