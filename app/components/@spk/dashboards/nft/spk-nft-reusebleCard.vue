...
<div class="card custom-card">
    <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
        ...
        <div>
            <span class="badge nft-like-badge text-default"><i class="ri-heart-fill me-1 text-danger d-inline-block"></i>{{ card.likes }}</span>
        </div>
    ...
    <div class="card-body p-2">
        <img :src="card.image" class="card-img mb-3" alt="...">
        <div class="p-2">
            <div class="mb-3">
                <NuxtLink to="/dashboards/nft/nft-details">
