            ...
            <div class="d-flex align-items-center flex-wrap justify-content-between gap-4 mb-3">
                <div class="flex-fill">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" :id="item.id" :value="item.walletAddress"
                ...
                <div>
                    <span class="avatar avatar-xxl border">
                        <img :src="item.imageSrc" class="p-1 qr-image" alt="">
                    </span>
                </div>
            </div>
            <div class="row gy-3">
                    ...
                    <div class="rounded p-3 border border-dashed">
                        <div class="d-flex align-items-center gap-3 flex-wrap">
                            ...
                            <div>
                                ...
                                <span class="d-block fw-medium">{{ item.received }}<span
                                        class="fs-12 text-muted fw-normal mx-1">{{ item.currency }}</span></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="rounded p-3 border border-dashed">
                        <div class="d-flex align-items-center gap-3 flex-wrap">
                            ...
                            <div>
                                ...
                                <span class="d-block fw-medium">{{ item.sent }}<span
                                        class="fs-12 text-muted fw-normal mx-1">{{ item.currency }}</span></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded p-3 border border-dashed">
                        <div class="d-flex align-items-center gap-3 flex-wrap">
                            ...
                            <div>
                                ...
                                <span class="d-block fw-medium">{{ item.balance }}<span
                                        class="fs-12 text-muted fw-normal mx-1">{{ item.currency }}</span></span>
                            </div>
                        </div>
                    </div>
